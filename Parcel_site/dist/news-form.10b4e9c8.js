...
},{"process":"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"admin_page/body/news_form/news-form.js":[function(require,module,exports) {
...
document.querySelector('#news-from-id').addEventListener('submit', function (e) {
  if ($('#text-area').val() == '') {
    e.preventDefault();
...
document.querySelector('#text-area').addEventListener("input", function (e) {
  $('.symbols').text("Символов " + e.target.value.length + "/150");
});
document.querySelector('.image-select-label__cancel').addEventListener("click", function (e) {
...
},{}]},{},["../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","admin_page/body/news_form/news-form.js"], null)
//# sourceMappingURL=/news-form.10b4e9c8.js.map